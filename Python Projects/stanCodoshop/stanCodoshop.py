...
def get_pixel_dist(pixel, red, green, blue):
    ...
    """
    color_d = ((red-pixel.red)**2 + (green-pixel.green)**2 + (blue-pixel.blue)**2) ** (1/2)
    return color_d
...
def solve(images):
    ...
    for x in range(width):
        for y in range(height):
            ...
            # Retrieve the list of pixels at (x,y) to get the best pixel
            pixels = []
            for image in images:
            ...
            # Assign the best RGB to the blank image
